pub fn recite(start_bottles: u32, take_down: u32) -> String {
    ...
    for i in 0..take_down {
        ...
        song.push_str(&format!("{current_word} green {current_bottle} hanging on the wall,\n"));
        song.push_str(&format!("{current_word} green {current_bottle} hanging on the wall,\n"));
        ...
        song.push_str(&format!("There'll be {next_word} green {next_bottle} hanging on the wall."));
